...
export const NAV_BY_ROLE: Record<UserRole, NavItem[]> = {
  ...
  admin: [
    ...
    { label: "Gestión", icon: PlusCircle, href: "/admin/empresas" },
    { label: "Profesionales", icon: Users, href: "/admin/profesionales" },
    { label: "Alumnos", icon: GraduationCap, href: "/admin/alumnos" },
